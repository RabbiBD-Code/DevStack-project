...
const ExploreTechnologyCard = ({ technology, setAddedStack, addedStack }: ExploreTechnologyCardProps) => {
  ...
  return (
    <div className="border border-gray-200 bg-gray-50 p-2 rounded-xl space-y-3">
      <div className="flex justify-between items-center ">
        ...
        />
        <span className={`${technology.badge == 'Popular'? "bg-green-700 " : "bg-blue-300"} text-white rounded-full px-4 p-1 text-sm font-semibold`}>
          {technology.badge}
        </span>
      </div>
